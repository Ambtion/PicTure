...
//        self.imageIdList = [NSMutableArray arrayWithCapacity:0];
        ...
        for (int i = 0; i < photoCount;  i++) {
            ...
            [prog setTrackImage:[[UIImage imageNamed:@"prog_wait.png"] stretchableImageWithLeftCapWidth:5.0 topCapHeight:5.0]];
...
- (void)updateViewWithPhoto:(SCPPhoto *)photo Position:(int)position PreToDel:(BOOL)pre
{
    ...
    if (photo.photoUrl) {
        ...
        NSString *url = [NSString stringWithFormat:@"%@_c283", photo.photoUrl];
