...
@interface PersonalPageManager : NSObject <UITableViewDataSource, PullingRefreshTableViewDelegate, FeedCellDelegate, PersonalPageCellDelegate, SCPRequestManagerDelegate, UIAlertViewDelegate>
{
